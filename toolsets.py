...
TOOLSETS = {
    ...
    "hermes-line": {
        "description": "LINE bot toolset - similar to Telegram (personal messaging, more trusted)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
